...
Este documento resume todo lo implementado dentro de `webcam/` hasta el 2026-09-12
...
1. Crea `webcam/.venv`.
2. Actualiza pip.
3. Instala las versiones fijadas en `webcam/requirements.txt`.
...
```powershell
.\webcam\start_tunnel.ps1 -Port 8000
```
...
Todavía no forman parte de `webcam/`:
